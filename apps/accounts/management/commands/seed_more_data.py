...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        vagas_extra = [
            ...
            ("Congelada", "CONGELADA", "Coordenador Financeiro", {"solicitada_em": now - timedelta(days=20), "aprovada_em": now - timedelta(days=18), "publicada_em": now - timedelta(days=17), "aprovada_por": rh, "status_pre_congelamento": "PUBLICADA"}),
